...
unique(Neonics$Species.Scientific.Name) #to get the unique values in the "Scientific Name" column
...
> Answer:Becasue we are more interested to know what is the dry mass compare to different functional groups, and the bar plot could shouw us the range, percentile, the mean, and the outliers of the dry mass; while the violin plot provide more information on the distribution shape of the biomass.
