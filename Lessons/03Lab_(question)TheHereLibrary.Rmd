...
# 1. 
NTL_df<-read.csv("/Users/inaliao/Desktop/EDE_Fall2023/Data/Raw/NTL-LTER_Lake_ChemistryPhysics_Raw.csv",stringsAsFactors = TRUE)


# 2.
file_EPA03<-dir(here('Data','Raw'),pattern=("EPAir_03*.csv"))
```
```{r}
View(file_EPA03)
```
